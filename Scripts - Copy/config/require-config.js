...
require.config({
    ...
    paths: {
        ...
        //For Form Search By ACE
        jqueryuicustom: "../assets/js/jquery-ui.custom.min",
        jqueryuitouch: "../assets/js/jquery.ui.touch-punch.min",
        chosenjquery: "../assets/js/chosen.jquery.min",
        spinbox: "../assets/js/spinbox.min",
        bootstrapdatepicker: "../assets/js/bootstrap-datepicker.min",
        bootstraptimepicker: "../assets/js/bootstrap-timepicker.min",
        daterangepicker: "../assets/js/daterangepicker.min",
        bootstrapcolorpicker: "../assets/js/bootstrap-colorpicker.min",
        knob: "../assets/js/jquery.knob.min",
        autosize: "../assets/js/autosize.min",
        inputlimiter: "../assets/js/jquery.inputlimiter.min",
        maskedinput: "../assets/js/jquery.maskedinput.min"
    },
    shim: {
        bootstrap: ["jquery"],
        amplify: {
        ...
        maskedinput: ["jqueryuicustom", "jqueryuitouch", "bootstrap", "bootstrapDatetimepicker", "bootstrapdatepicker", "bootstraptimepicker", "daterangepicker", "bootstrapcolorpicker", "chosenjquery", "spinbox", "knob", "autosize", "inputlimiter"]
    }
});

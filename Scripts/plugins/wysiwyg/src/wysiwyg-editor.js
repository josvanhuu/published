(function (factory) {
    ...
    var create_editor = function ($textarea, classes, placeholder, toolbar_position, toolbar_buttons, toolbar_submit, label_selectImage,
            ...
            $fileuploader_input.fileupload({
                ...
                add: function (e, data) {
                    ...
                    if (allowUpload)
                        ...
                        toastr.error("Tệp tin tải lên không đúng định dạng.");
                },
        ...
        var content_upload_file = function (wysiwygeditor) {
            ...
            $fileuploader_input.fileupload({
                ...
                add: function (e, data) {
                    ...
                    for (var i = 0; i < data.files.length; i++) {
                        var ext = data.files[i].name.replace(/^.*\./, '');
            ...
            //if (placeholder_url)
            //    $inputurl.attr('placeholder', 'Nhập đường đẫn file'); // HoangNH: Hiện tại đang fix. Sau này sửa lại để có thể đa ngôn ngữ

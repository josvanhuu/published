    ...
    var container = ".proviewEditorContainer",
        ...
        defaults = {
            ...
            uploadImage: {
                ...
                placeholder: "Chọn hoặc kép thả tệp tin vào đây"
            },
            fileUpload: {
                url: "",
                callback: null,
            ...
            toolbarButtons: ['smiles', 'bold', 'italic', 'underline', 'fontname', 'fontsize', 'link', 'image', 'video', 'alignleft', 'aligncenter', 'alignright', 'removeformat'],
            popupHoverButtons: {},
            // ----------- Event
            onKeydown: null,
            onKeyPress: null,
